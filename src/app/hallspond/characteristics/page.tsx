...
export default function HallsPondChar() {
    return (
        <div className="flex flex-col h-dvh max-w-[100%] items-center">
            ...
            <CharacteristicsContainerL src="https://res.cloudinary.com/dfcqlwnxu/image/upload/w_1200,q_75/v1746156128/deadStanding_tfi2nv.jpg" title="Dead Standing Trees" width={500} height={400} desc={
            ...
            <CharacteristicsContainerR src="https://res.cloudinary.com/dfcqlwnxu/image/upload/w_1200,q_75/v1746155790/rotLog_qnk1ue.jpg" title="Rotting Logs" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
            ...
            <CharacteristicsContainerL src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1746155469/lowplant_x1bsfj.jpg" title="Thick Ground Vegetation" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
            ...
            <CharacteristicsContainerR src="https://res.cloudinary.com/dfcqlwnxu/image/upload/w_1200,q_75/v1746156402/patchy_kfb4fq.jpg" title="Patchy Ecosystem Structure" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
                <li>A landscape composed of diverse habitat patches, such as wetlands, meadows, and forests</li>
                <li>Supports a wide range of species with varying habitat requirements</li>
                <li>allows for greater biodiversity, as different species can find suitable niches, and enhances resilience to environmental changes</li>
                </ul>
            }/>
            <CharacteristicsContainerL src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1746155202/leafpile_dd56wh.jpg" title="Leaf Litter and Organic Ground Cover" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
            ...
            <CharacteristicsContainerR src="https://res.cloudinary.com/dfcqlwnxu/image/upload/v1746155405/canopy_z4eybh.jpg" title="Sparse to Dense Canopy Variation" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
            ...
            <CharacteristicsContainerL src="https://res.cloudinary.com/dfcqlwnxu/image/upload/w_1200,q_75/v1746156520/boardwalk_yq9rfu.jpg" title="Minimal Environmental Disturbance" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
                ...
                <li>Example: Elevated wooden boardwalks, prohibition of ball games and dog walking</li>
                </ul>
            }/>
            <CharacteristicsContainerR src="https://res.cloudinary.com/dfcqlwnxu/image/upload/w_1200,q_75/v1746155610/halls-3_szufbq.jpg" title="Sustainable Design Practices" width={600} height={400} desc={
                <ul className="list-disc pl-5 space-y-1">
            ...
            <div className="flex justify-center pb-[7%] w-[90%] h-[90%]">
                <VideoPlayer src="https://www.youtube.com/embed/qQaizDGgG9k"/>
            </div>
        </div>
    )
}